...
//agregamos una nueva línea en posicion
        //p.ver(s.InsertarLineaEnPosicion("C", "Archivos", "mensaje2", 4).resultado, Retorno.Resultado.OK, "Se inserta linea en posicion 2 dentro de mensaje2 en carpeta Archivos" + "\n");
...
//        p.ver(s.InsertarLineaEnPosicion("C", "Archivos", "mensaje1", 3).resultado, Retorno.Resultado.OK, "Se inserta linea en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
        p.ver(s.InsertarLineaEnPosicion("C", "Archivos", "mensaje2", 4).resultado, Retorno.Resultado.OK, "Se inserta linea en posicion 4 dentro de mensaje1 en carpeta Archivos" + "\n");
...
//        p.ver(s.ListarEstructura("C", "Archivos").resultado, Retorno.Resultado.OK, "Se muestra la estrucura actual del sistema" + "\n" + s.ListarEstructura("C", "Archivos").valorString);
       ...
       p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 2, 1, "palabra1").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
       p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 2, 2, "palabra2").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 2, 3, "palabra3").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 3, 1, "palabra1").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 3, 2, "palabra2").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje2", 3, 3, "palabra3").resultado, Retorno.Resultado.OK, "Se inserta palabra en posicion 1 dentro de mensaje1 en carpeta Archivos" + "\n");
...
// p.ver(s.BorrarLinea("C", "Archivos", "mensaje1", 1).resultado, Retorno.Resultado.OK, "Se borra linea en posicion 8 dentro de mensaje1 en carpeta Archivos" + "\n");
        ...
        p.ver(s.InsertarPalabraYDesplazar("C", "Archivos", "mensaje2", 3/*línea*/, 2/*pos.palabra*/,"palabra4").resultado, Retorno.Resultado.OK, "se inserta palabra4 en línea 3, posición 2" + "\n");
        p.ver(s.InsertarPalabraYDesplazar("C", "Archivos", "mensaje2", 3/*línea*/, 2/*pos.palabra*/,"palabra5").resultado, Retorno.Resultado.OK, "se inserta palabra4 en línea 3, posición 2" + "\n");
