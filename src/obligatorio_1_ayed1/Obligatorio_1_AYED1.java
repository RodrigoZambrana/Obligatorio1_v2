...
//casos OK
        p.ver(s.BorrarTodo("C", "Archivos", "mensaje2").resultado, Retorno.Resultado.OK, "Se borra toda la informacion de mensaje 2");
//  listamos par ver si la estructura es correcta
        p.ver(s.ListarEstructura("C", "Archivos").resultado, Retorno.Resultado.OK, "Se listan los documentos de la carpeta Archivos" + "\n" + s.ListarEstructura("C", "Archivos").valorString);

        //casos ERROR
        p.ver(s.BorrarTodo("C", "Archivos", "mensaje20").resultado, Retorno.Resultado.ERROR, "Se intenta borrar todo de un mnesaje que no existe");
...
//casos OK
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 1, "insertar").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 2, "palabra").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 3, "linea").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
...
//casos OK
        p.ver(s.BorrarPalabra("C", "Archivos", "mensaje1", 1, 1).resultado, Retorno.Resultado.OK, "Se borra palabra");
        p.ver(s.BorrarPalabra("C", "Archivos", "mensaje1", 1, 3).resultado, Retorno.Resultado.OK, "Se borra palabra");
...
//casos OK
        p.ver(s.BorrarOcurrenciasPalabraEnLinea("C", "Archivos", "mensaje1", 1, "palabra").resultado, Retorno.Resultado.ERROR, "");

//casos ERROR
// Retorno ImprimirLinea(String unidad, String carpeta, String mensaje,int posicionLinea);//()
        p.ver(s.ImprimirLinea("C", "Archivos", "mensaje1", 1).resultado, Retorno.Resultado.ERROR, "");

//casos OK
//casos ERROR
// Retorno BorrarOcurrenciasPalabraEnTexto(String unidad, String carpeta, String mensaje,String palabraABorrar);
//casos OK
        p.ver(s.BorrarOcurrenciasPalabraEnTexto("C", "Archivos", "mensaje1", "palabra").resultado, Retorno.Resultado.ERROR, "");
        p.ver(s.BorrarOcurrenciasPalabraEnTexto("C", "Archivos", "mensaje2", "insertar").resultado, Retorno.Resultado.ERROR, "");
        p.ver(s.BorrarOcurrenciasPalabraEnTexto("C", "Archivos", "mensaje3", "borrar").resultado, Retorno.Resultado.ERROR, "");
