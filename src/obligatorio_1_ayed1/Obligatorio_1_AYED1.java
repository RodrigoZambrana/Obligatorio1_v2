...
////casos OK
        p.ver(s.BorrarOcurrenciasPalabraEnTexto("C", "Archivos", "mensaje1", "palabra").resultado, Retorno.Resultado.OK, "Se borra ocurrencias de palabra en el texto");
...
////casos OK  REIVSAR
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 2, "insertarX").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 3, "unaX").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
        p.ver(s.InsertarPalabraEnLinea("C", "Archivos", "mensaje1", 1, 4, "palabraX").resultado, Retorno.Resultado.OK, "Se inserta palabra en linea");
...
////casos OK
        p.ver(s.BorrarOcurrenciasPalabraEnLinea("C", "Archivos", "mensaje1", 1, "insertarX").resultado, Retorno.Resultado.OK, "SE BORRA PALABRA");
